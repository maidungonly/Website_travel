...
class Customer(models.Model):
    ...
    email = models.CharField(validators=[email_regex], max_length=200, null=True)
    ...
    phone_number = models.CharField(validators=[phone_regex], max_length=12, blank=True, null=True, default='0931615531')
